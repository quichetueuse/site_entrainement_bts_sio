...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Employes</title>
    <link rel="stylesheet" href="style_employes_dashboard.css">
    <script src="script_employes_dashboard.js"></script>
</head>
...
<div id="container">
    ...
    <div id="iframe-div">
        <iframe src="page_employes_summary.php" id="iframe-affichage"></iframe>
    </div>
</div>
</body>
</html>
