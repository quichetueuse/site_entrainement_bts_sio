...
<form method="post">
    <div style="display: flex; flex-direction: column; justify-content: center; align-content: center;">
        ...
        <div style="display: flex; flex-direction: row; justify-content: center; width: 30%; margin-left:auto; margin-right: auto; margin-top: 30px;">
            ...
            <select id="select-especes-search" name="select-especes-search" class="dashboard-input">
                <?php
...
//    echo "entered";
                            ...
                            $nom = $_POST['select-especes-search'];
//                        echo $nom;
                            $requete = "SELECT * FROM `especes` WHERE nom_race='$nom'";
