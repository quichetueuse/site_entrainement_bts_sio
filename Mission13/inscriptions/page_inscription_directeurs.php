...
<!--            <img src="../Assets/logo-zoo.png" id="logo-zoo">-->
            <label>Zoo</label>
            <label>Directeur</label> <!--style="margin: auto 0;"-->
        </div>

        <div id="div-image-boss" style="display: flex; justify-content: center; margin: 20px;">
            <img src="../Assets/Gman.png">
        </div>
        <hr>
        ...
        <div style="display: flex; flex-direction: column; text-align: center; width: 85%;background-image: url('../Assets/inside-company-icon.png')">
            <label style="text-align: center; margin-right: auto; margin-left: auto; font-weight: bold; font-size: 42px; margin-top: 10px; color: white">🐒Inscrivez-vous en tant que directeur! 🐒</label>
            <form method="post">
...
//    $requete = "INSERT INTO access (Email, Password) VALUES ('$email', '$password')";
    include("../connexion_bd.php");
    $requete = "INSERT INTO `personnels` (nom, prenom, date_naissance, login, password, salaire, sexe, fonction) VALUES ('$nom', '$prenom', '$date_naissance', '$login', '$password', 0, '$sexe', 'Directeur')";
    $resultat = mysqli_query($conn, $requete);
    if($resultat)
    {
//        echo "Success";
